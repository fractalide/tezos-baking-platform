/*opam-version: "2.0"
  ...
  "https://github.com/mirleft/ocaml-tls/releases/download/0.9.1/tls-0.9.1.tbz"
    checksum: "md5=6540028f450dd753dc90d8a4ba6bb457"
  }*/
...
assert stdenv.lib.versionOlder (stdenv.lib.getVersion ppx_sexp_conv)
  "v0.11.0";
assert stdenv.lib.versionAtLeast (stdenv.lib.getVersion ppx_cstruct) "3.0.0";
assert stdenv.lib.versionAtLeast (stdenv.lib.getVersion cstruct) "3.0.0";
assert stdenv.lib.versionAtLeast (stdenv.lib.getVersion nocrypto) "0.5.4";
assert stdenv.lib.versionAtLeast (stdenv.lib.getVersion x509) "0.6.1";
assert doCheck -> stdenv.lib.versionAtLeast (stdenv.lib.getVersion
  cstruct-unix) "3.0.0";
assert !stdenv.lib.versionOlder (stdenv.lib.getVersion lwt) "2.4.8";
assert stdenv.lib.getVersion sexplib != "v0.9.0";
assert !stdenv.lib.versionOlder (stdenv.lib.getVersion ptime) "0.8.1";
