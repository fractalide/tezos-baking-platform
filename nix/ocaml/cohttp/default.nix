/*opam-version: "2.0"
  ...
  * `Cohttp_lwt_xhr` compiles to a JavaScript module that maps the Cohttp
  ...
  "https://github.com/mirage/ocaml-cohttp/releases/download/v1.1.0/cohttp-1.1.0.tbz"
    checksum: "md5=7624e77774b90112370924f2d21af436"
  }*/
...
assert stdenv.lib.versionAtLeast (stdenv.lib.getVersion jbuilder)
  "1.0+beta10";
assert stdenv.lib.versionAtLeast (stdenv.lib.getVersion re) "1.7.2";
assert stdenv.lib.versionAtLeast (stdenv.lib.getVersion uri) "1.9.0";
assert stdenv.lib.versionAtLeast (stdenv.lib.getVersion ppx_type_conv)
  "v0.9.1";
assert stdenv.lib.versionAtLeast (stdenv.lib.getVersion ppx_fields_conv)
  "v0.9.0";
assert stdenv.lib.versionAtLeast (stdenv.lib.getVersion ppx_sexp_conv)
  "v0.9.0";
assert stdenv.lib.versionAtLeast (stdenv.lib.getVersion base64) "2.0.0";
