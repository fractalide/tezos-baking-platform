...
in stdenv.mkDerivation rec {
  ...
  patches = [ ../patches/opam-pull-3487.patch ../patches/opam-shebangs.patch ];
...
# Generated by: opam.nix.pl -v 2.0.0 -p ../patches/opam-pull-3487.patch,../patches/opam-shebangs.patch
