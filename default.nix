...
rec {
  ...
  tezos-loadtest = (import ./tezos-bake-monitor/tezos-bake-central/.obelisk/impl {}).reflex-platform.nixpkgs.haskellPackages.callCabal2nix "tezos-loadtest" ./tezos-load-testing {};
